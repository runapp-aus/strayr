...
#'
#' Wide table containing all levels of the Australian and New Zealand Standard
#' Classification of Occupations (ANZSCO), 2021 Australian Update
#'
#' @format A \code{tibble} with 11 variables:
#' \describe{
#' \item{\code{anzsco_major_code}}{Major ANZSCO group codes, e.g. "4"}
...
#'
#' Wide table containing all levels of the Australian and New Zealand Standard
#' Classification of Occupations (ANZSCO), 2022 Australian Update
#'
#' @format A \code{tibble} with 11 variables:
#' \describe{
#' \item{\code{anzsco_major_code}}{Major ANZSCO group codes, e.g. "4"}
...
#' See \url{https://www.abs.gov.au/ausstats/abs@.nsf/Previousproducts/C4BECE1704987586CA257089001A9181 } for details.}
#' }
#' @source \url{https://www.abs.gov.au/statistics/classifications/anzsco-australian-and-new-zealand-standard-classification-occupations/latest-release}
"anzsco2022"
